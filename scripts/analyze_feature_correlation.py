...
Cách chạy:
  ...
  python scripts/analyze_feature_correlation.py --sector "Bất động sản"

  # Phân tích tất cả sector (mỗi sector 1 output folder)
  python scripts/analyze_feature_correlation.py --all-sectors

  # Phân tích 1 nhóm mã cụ thể
  python scripts/analyze_feature_correlation.py --stocks BCM,DIG,KOS,NLG,VHM,VIC

  # Đặt ngưỡng correlation khác (mặc định 0.75)
  python scripts/analyze_feature_correlation.py --sector "Bất động sản" --threshold 0.70
"""
