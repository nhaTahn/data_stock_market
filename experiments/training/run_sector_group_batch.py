...
DEFAULT_CONTEXT_FEATURES = "alpha_sector,market_leader_return,vnindex_return,a_d_ratio,day_of_week,rsi_14"
...
def main() -> None:
    ...
    run_and_log(
        [str(ROOT / "venv" / "bin" / "python"), "main.py", "data", "build", "--market", "VN"],
