...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| gate | `vn_legacy_acc_all_else_transition_pressure_nonneg` | 4 | 1.186 | 1.460 | +0.55 | -21.7% | 0.18 | Passes both artifacts and the risk-control screen. |

## Stable Non-Oracle Policies

| Kind | Policy | Artifacts | Min equity | Mean equity | Min Sharpe | Worst DD | Max turnover | Read |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| gate | `vn_legacy_acc_all_else_transition_pressure_nonneg` | 4 | 1.186 | 1.460 | +0.55 | -21.7% | 0.18 | Passes both artifacts, but still needs stricter validation. |
| gate | `conservative_prior_transition_pressure_nonneg` | 4 | 1.068 | 1.406 | +0.27 | -21.7% | 0.21 | Passes both artifacts, but still needs stricter validation. |
| gate | `vn_legacy_acc_markup_all_else_transition_pressure_nonneg` | 4 | 1.068 | 1.406 | +0.27 | -21.7% | 0.21 | Passes both artifacts, but still needs stricter validation. |
| gate | `vn_h1_distribution_transition` | 4 | 1.057 | 1.080 | +0.24 | -39.4% | 0.22 | Passes both artifacts, but still needs stricter validation. |
| gate | `baseline_all_committee_transition_mr20_pressure_nonneg` | 4 | 1.006 | 1.094 | +0.11 | -29.8% | 0.17 | Passes both artifacts, but still needs stricter validation. |
| gate | `baseline_all_committee_transition_pressure_nonneg` | 4 | 1.006 | 1.244 | +0.12 | -29.8% | 0.16 | Passes both artifacts, but still needs stricter validation. |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| gate | `vn_legacy_acc_all_else_transition_pressure_nonneg` | 1.186 | 1.460 | +0.55 | -21.7% | 0.18 | 4 | False |
| gate | `conservative_prior_transition_pressure_nonneg` | 1.068 | 1.406 | +0.27 | -21.7% | 0.21 | 4 | False |
| gate | `vn_legacy_acc_markup_all_else_transition_pressure_nonneg` | 1.068 | 1.406 | +0.27 | -21.7% | 0.21 | 4 | False |
| gate | `vn_h1_distribution_transition` | 1.057 | 1.080 | +0.24 | -39.4% | 0.22 | 4 | False |
| gate | `baseline_all_committee_transition_mr20_pressure_nonneg` | 1.006 | 1.094 | +0.11 | -29.8% | 0.17 | 4 | False |
| gate | `baseline_all_committee_transition_pressure_nonneg` | 1.006 | 1.244 | +0.12 | -29.8% | 0.16 | 4 | False |
...
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `oracle_eval_phase_best` | 1.385 | +0.80 | -30.7% | 0.28 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_h1_transition_only` | 1.255 | +0.59 | -21.7% | 0.26 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `conservative_prior_transition_mr20_pressure_nonneg` | 1.224 | +0.62 | -21.7% | 0.18 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_legacy_acc_markup_all_else_transition_mr20_pressure_nonneg` | 1.224 | +0.62 | -21.7% | 0.18 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `conservative_prior_transition_mr20_nonneg` | 1.215 | +0.59 | -21.7% | 0.18 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_legacy_acc_markup_all_else_transition_mr20_nonneg` | 1.215 | +0.59 | -21.7% | 0.18 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `conservative_prior_transition_pressure_nonneg` | 1.213 | +0.60 | -21.7% | 0.17 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_legacy_acc_markup_all_else_transition_pressure_nonneg` | 1.213 | +0.60 | -21.7% | 0.17 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_legacy_acc_all_else_transition_mr20_pressure_nonneg` | 1.198 | +0.58 | -21.7% | 0.14 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_legacy_acc_all_else_transition_mr20_nonneg` | 1.196 | +0.56 | -21.7% | 0.14 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_legacy_acc_all_else_transition_pressure_nonneg` | 1.186 | +0.55 | -21.7% | 0.13 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_h1_distribution_only_transition_mr20_nonneg` | 1.168 | +0.46 | -26.5% | 0.24 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `conservative_prior` | 1.123 | +0.38 | -23.5% | 0.16 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_legacy_acc_markup_all_else` | 1.123 | +0.38 | -23.5% | 0.16 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_h1_distribution_only_transition_pressure_nonneg` | 1.122 | +0.38 | -26.5% | 0.23 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_h1_distribution_only_transition_mr20_pressure_nonneg` | 1.117 | +0.37 | -26.5% | 0.23 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_h1_distribution_transition` | 1.109 | +0.33 | -38.1% | 0.20 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_legacy_acc_all_else` | 1.083 | +0.30 | -23.5% | 0.12 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_h1_distribution_only` | 1.074 | +0.27 | -32.8% | 0.24 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `aggressive_prior` | 1.024 | +0.17 | -34.7% | 0.15 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `vn_h1_markup_distribution_transition` | 1.024 | +0.17 | -34.7% | 0.15 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `baseline_all_committee_transition_mr20_pressure_nonneg` | 1.016 | +0.14 | -29.8% | 0.12 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `baseline_all_committee_transition_mr20_nonneg` | 1.014 | +0.14 | -29.8% | 0.12 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `baseline_all_committee_transition_pressure_nonneg` | 1.006 | +0.12 | -29.8% | 0.11 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `baseline_all_committee` | 0.919 | -0.07 | -35.1% | 0.10 |
...
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `train_phase_regularized_m10_dd20_t25` | 0.860 | -0.18 | -39.8% | 0.26 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `train_phase_regularized_m15_dd20_t25` | 0.860 | -0.18 | -39.8% | 0.26 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `baseline_h1` | 0.826 | -0.26 | -43.8% | 0.12 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `train_phase_best` | 0.765 | -0.38 | -46.5% | 0.25 |
| `portable_lstm_filter_signal_20260512_r02_no_leader_seed43` | gate | `baseline_legacy` | 0.764 | -0.45 | -42.4% | 0.14 |
