...
from src.reporting import report_plot_path
...
def save_actual_vs_prediction_plot(
    run_dir: Path,
...
def save_rel_score_hist_plot(run_dir: Path, model_name: str, split_names: tuple[str, ...] | None = None) -> None:
    split_frames: list[tuple[str, pd.DataFrame]] = []
    for split_name in split_names or ("train", "val", "test"):
