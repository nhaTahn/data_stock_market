...
| gate | `train_phase_robust_abstain_m10_dd15_t20_ts050_pf60` | 2 | 1.111 | 1.250 | +0.55 | -23.9% | 0.16 | Passes both artifacts and the risk-control screen. |
...
| gate | `train_phase_robust_abstain_m15_dd15_t20_ts050_pf60` | 2 | 1.111 | 1.144 | +0.55 | -23.9% | 0.15 | Passes both artifacts and the risk-control screen. |
...
| gate | `train_phase_robust_abstain_m10_dd15_t20_ts050_pf60` | 2 | 1.111 | 1.250 | +0.55 | -23.9% | 0.16 | Passes both artifacts, but still needs stricter validation. |
...
| gate | `train_phase_robust_abstain_m15_dd15_t20_ts050_pf60` | 2 | 1.111 | 1.144 | +0.55 | -23.9% | 0.15 | Passes both artifacts, but still needs stricter validation. |
...
| gate | `train_phase_regularized_m15_dd15_t20` | 2 | 1.103 | 1.138 | +0.38 | -30.7% | 0.22 | Passes both artifacts, but still needs stricter validation. |
...
| gate | `train_phase_robust_abstain_m05_dd15_t20_ts050_pf60` | 2 | 1.001 | 1.195 | +0.10 | -30.9% | 0.19 | Passes both artifacts, but still needs stricter validation. |
| gate | `train_phase_robust_abstain_m05_dd20_t25_ts050_pf60` | 2 | 1.001 | 1.195 | +0.10 | -30.9% | 0.19 | Passes both artifacts, but still needs stricter validation. |
...
| gate | `train_phase_robust_abstain_m10_dd15_t20_ts050_pf60` | 1.111 | 1.250 | +0.55 | -23.9% | 0.16 | 2 | False |
| gate | `train_phase_robust_abstain_m15_dd20_t25_ts050_pf60` | 1.111 | 1.144 | +0.55 | -23.9% | 0.15 | 2 | False |
| gate | `train_phase_robust_abstain_m15_dd15_t20_ts050_pf60` | 1.111 | 1.144 | +0.55 | -23.9% | 0.15 | 2 | False |
...
| gate | `train_phase_regularized_m15_dd20_t25` | 1.103 | 1.138 | +0.38 | -30.7% | 0.22 | 2 | False |
| gate | `train_phase_regularized_m15_dd15_t20` | 1.103 | 1.138 | +0.38 | -30.7% | 0.22 | 2 | False |
...
| `portable_lstm_filter_signal_20260508_r05_signmag` | gate | `train_phase_regularized_m15_dd15_t20` | 1.174 | +0.57 | -29.5% | 0.21 |
...
| `portable_lstm_filter_signal_20260508_r05_signmag` | gate | `train_phase_robust_abstain_m10_dd15_t20_ts050_pf60` | 1.111 | +0.55 | -23.9% | 0.15 |
| `portable_lstm_filter_signal_20260508_r05_signmag` | gate | `train_phase_robust_abstain_m15_dd15_t20_ts050_pf60` | 1.111 | +0.55 | -23.9% | 0.15 |
...
| `portable_lstm_filter_signal_20260508_r05_signmag` | gate | `train_phase_robust_abstain_m05_dd15_t20_ts050_pf60` | 1.001 | +0.10 | -30.9% | 0.19 |
| `portable_lstm_filter_signal_20260508_r05_signmag` | gate | `train_phase_robust_abstain_m05_dd20_t25_ts050_pf60` | 1.001 | +0.10 | -30.9% | 0.19 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_robust_abstain_m05_dd20_t25_ts050_pf60` | 1.388 | +0.93 | -23.9% | 0.16 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_robust_abstain_m05_dd15_t20_ts050_pf60` | 1.388 | +0.93 | -23.9% | 0.16 |
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_robust_abstain_m10_dd15_t20_ts050_pf60` | 1.388 | +0.93 | -23.9% | 0.16 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_robust_abstain_m15_dd15_t20_ts050_pf60` | 1.177 | +0.69 | -19.6% | 0.12 |
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m15_dd20_t25` | 1.103 | +0.38 | -30.7% | 0.22 |
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m15_dd15_t20` | 1.103 | +0.38 | -30.7% | 0.22 |
