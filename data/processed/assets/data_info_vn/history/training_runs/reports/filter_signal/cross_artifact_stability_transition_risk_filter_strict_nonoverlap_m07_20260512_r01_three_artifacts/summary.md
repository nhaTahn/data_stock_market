...
| gate | `train_phase_regularized_m10_dd20_t25_transition_pressure_nonneg` | 0.994 | 1.231 | +0.08 | -21.7% | 0.23 | 1 | False |
| gate | `train_phase_regularized_m15_dd20_t25_transition_pressure_nonneg` | 0.994 | 1.099 | +0.08 | -28.0% | 0.23 | 1 | False |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m10_dd20_t25` | 1.520 | +0.94 | -23.6% | 0.25 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m10_dd20_t25_transition_pressure_nonneg` | 1.468 | +0.95 | -21.7% | 0.23 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m10_dd20_t25_transition_mr20_pressure_nonneg` | 1.369 | +0.81 | -21.7% | 0.23 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m15_dd20_t25` | 1.272 | +0.60 | -28.0% | 0.24 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m15_dd20_t25_transition_pressure_nonneg` | 1.204 | +0.53 | -28.0% | 0.22 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m10_dd20_t25_transition_mr20_nonneg` | 1.184 | +0.47 | -24.6% | 0.24 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m15_dd20_t25_transition_mr20_pressure_nonneg` | 1.122 | +0.38 | -28.0% | 0.22 |
...
| `portable_lstm_filter_signal_20260509_r06_selector_module` | gate | `train_phase_regularized_m15_dd20_t25_transition_mr20_nonneg` | 0.971 | +0.05 | -28.0% | 0.23 |
