...
| gate | `oracle_eval_phase_best` | 1.240 | 1.351 | +0.76 | -26.8% | 0.29 | 2 | True |
| gate | `vn_h1_transition_only` | 0.943 | 1.094 | -0.04 | -25.4% | 0.28 | 1 | False |
| committee | `h0_forecast_abs` | 0.873 | 0.977 | -0.16 | -35.5% | 0.14 | 1 | False |
| committee | `legacy_filter_shortlist` | 0.838 | 1.052 | -0.50 | -32.9% | 0.14 | 1 | False |
| gate | `baseline_legacy` | 0.838 | 1.052 | -0.50 | -32.9% | 0.14 | 1 | False |
| committee | `h3_rank_committee` | 0.816 | 1.013 | -0.47 | -30.0% | 0.15 | 1 | False |
| gate | `vn_h1_distribution_transition` | 0.740 | 1.163 | -0.65 | -32.7% | 0.26 | 1 | False |
| gate | `conservative_prior` | 0.739 | 1.114 | -0.55 | -41.8% | 0.18 | 1 | False |
| gate | `vn_legacy_acc_markup_all_else` | 0.739 | 1.114 | -0.55 | -41.8% | 0.18 | 1 | False |
| committee | `h1_tradeability_filter` | 0.712 | 1.056 | -0.73 | -35.6% | 0.26 | 1 | False |
