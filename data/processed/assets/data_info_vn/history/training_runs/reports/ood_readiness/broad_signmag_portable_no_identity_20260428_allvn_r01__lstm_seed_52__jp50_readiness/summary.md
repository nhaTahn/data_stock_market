...
## Prediction Metrics
- rel_score: `-0.00221`
- directional_accuracy: `49.2%`
- error q2/q8 (E = prediction - actual): `-0.01371` / `+0.01186`
- error mean/std: `-0.00075` / `0.02069`

## Ranking Metrics
- mean daily Spearman IC: `+0.01578`
- IC t-stat: `+1.70`
- positive IC days: `52.5%`
- quartile equity: `1.377`
- quartile hit rate: `51.6%`
- quartile max drawdown: `-22.3%`
